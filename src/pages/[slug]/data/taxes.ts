...
const stages = [
    {
        ...
        description: 'Обжалуем доначисления, штрафы, блокировки счетов. Защита в суде.',
    },
    {
        key: '2',
        title: 'Подготовка и подача налоговой отчётности ',
        description: 'Оформим и подадим декларации, поможем избежать ошибок и штрафов.',
    },
    {
        key: '3',
...
export const taxesService = {
    ...
    stageDescription:
        'Решаем налоговые споры, сопровождаем проверки, возвращаем налоги и помогаем с отчётностью.',
    stageImg: LegalImage,
