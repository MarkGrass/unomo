...
const stages = [
    ...
    },
    {
        ...
        description: 'Защитим от давления, зафиксируем факты, восстановим ваши права.',
    },
];
...
export const workService = {
    ...
    meta: 'Трудовые споры',
    stageDescription:
        'Незаконное увольнение? Не выплатили зарплату? Давят дисциплинаркой? Поможем восстановить справедливость и отстоим ваши трудовые права.',
    stageImg: LegalImage,
